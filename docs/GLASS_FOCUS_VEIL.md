...
独立して、設定パネル内で混ぜるシャープな背景サンプルを減らし、淡いtintを少し
強めることで、通常のフォルダよりも曇りガラスに近い見た目にしています。
...
| 設定パネルのProminent材質をブラー・tintへ反映する | `src/renderer/prepare.rs`、`src/liquid_glass/renderer.rs`、`assets/shaders/liquid_glass_final.wgsl` |
