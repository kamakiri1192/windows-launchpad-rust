...
/// One drawable icon instance, matching the WGSL `@location(0..3)` instance
/// attributes. 64 bytes for clean GPU alignment.
///
...
pub struct IconInstance {
    ...
    pub extra: [f32; 4],
    /// Common rigid-group pivot `(x, y, enabled, padding)`.
    pub motion_pivot: [f32; 4],
}
